...
from image import file_operator as op
...
def get_coor(img_pos_folder, img_none_folder):
    ...
    # img_pos_folder = r"D:\data\sample_farm2\sg\img_1000"
    # img_none_folder = r"D:\data\sample_farm2\sg\kuang_grey"
    # img_none_folder = r"D:\data\sample_farm2\sg\img_sg_1024"
    save_folder = img_none_folder + '_proj'
    ...
    #复制移动
    op.scan_files(img_none_folder, save_folder, '_proj.tif')