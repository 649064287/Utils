...
if __name__ == "__main__":
    ...
    run = GRID()
    png_path = r"E:\data\BDCN\yantian\fusion_15000\fusion"
    img_path = r"E:\data\yantian\test\img\1000_3bands"

    out_tif_path = r"E:\data\BDCN\yantian\fusion_15000\fusion_tif"
    ...
    for file in os.listdir(img_path):
        ...
        proj, geotrans, data1, row1, column1 = run.read_img(img_path+'/'+file)  # 读数据,获取tif图像的信息
